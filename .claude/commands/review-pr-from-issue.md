...
Goal of this PR: Implement the requirements of GitHub issue {{github-issue}}.

You have access to the GitHub CLI. Use `gh --help` for syntax.

You can access the contents of the GitHub issue using the command `gh view {{github-issue}}`
...
You have access to the git CLI. You can see the diff by comparing branch `issue-{{github-issue}}` against `main`.
