...
const ZOOM_ICON_SIZE = 'w-12 h-12'; // 48x48px magnifying glass icon
const OVERLAY_OPACITY = 'bg-black/50'; // 50% black overlay for hover state
const ICON_BACKGROUND = 'bg-white/90'; // 90% white background for icon
const FOCUS_RING = 'focus:ring-4 focus:ring-blue-500 focus:ring-offset-2'; // WCAG AA compliant focus indicator

// Keyboard navigation keys
const KEYBOARD_TRIGGER_KEYS = ['Enter', ' '] as const; // Space key requires literal space character
...
/**
 * Client-side interactive gallery detail component.
 *
 ...
 * @returns Interactive gallery detail component with lightbox
 */
export function GalleryDetailClient({ artwork }: GalleryDetailClientProps) {
