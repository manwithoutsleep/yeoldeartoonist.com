...
export default async function RootLayout({
    ...
    // Read the CSP nonce from middleware headers
    // This nonce is generated by middleware and used in the Content-Security-Policy header
    ...
    return (
        <html lang="en">
            ...
            >
                ...
                <PublicLayoutWrapper nonce={nonce}>
                    {children}
                </PublicLayoutWrapper>
